...
class TimetableCarouselScreenV2 extends StatefulWidget {
  const TimetableCarouselScreenV2({Key? key}) : super(key: key);

  @override
  State<TimetableCarouselScreenV2> createState() => _TimetableCarouselScreenV2State();
}

class _TimetableCarouselScreenV2State extends State<TimetableCarouselScreenV2> {
                ...
                builder: (context, constraints) {
                  return Column(
                    ...
                    children: [
                      ...
                      // Using Flexible to allow resizing
                      Flexible(
                        flex: 4,
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Subject Title - Adaptive Text Size
                                  Flexible(
                                    child: Text(
