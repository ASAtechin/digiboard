...
// --- Main Screen Widget (Version 3 - Auto Transition) ---

class TimetableCarouselScreenV3 extends StatefulWidget {
  const TimetableCarouselScreenV3({Key? key}) : super(key: key);

  @override
  State<TimetableCarouselScreenV3> createState() => _TimetableCarouselScreenV3State();
}

class _TimetableCarouselScreenV3State extends State<TimetableCarouselScreenV3> {
...
// --- Detailed Lecture Card V3 ---

class LectureDetailCardV3 extends StatelessWidget {
  final Lecture lecture;
  final bool isCurrent;
  final int lectureIndex;

  const LectureDetailCardV3({
    Key? key,
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Icon(Icons.sticky_note_2_outlined, color: themeColor, size: 20),
                                        const SizedBox(width: 8),
                                        Text(
                                          'NOTES',
                                          style: TextStyle(
                                    ...
                                    Expanded(
                                      child: SingleChildScrollView(
                                        child: Text(
                                          lecture.description ?? 'No notes available for this session.',
                                          style: TextStyle(
